...
//To optimize this code and prevent unnecessary re-renders of the Child component, you can use the useCallback hook to memoize the handlechildclick function. This way, the function reference remains the same across renders unless its dependencies 